...
- 🐛 **Recherche de vin inopérante à l'ajout** : la fonction transmettant vos saisies à l'IA était appelée mais n'avait jamais été écrite. Chaque recherche échouait aussitôt, le message « Recherche en cours… » restait affiché indéfiniment et aucun résultat n'apparaissait — rendant l'ajout d'une bouteille impossible par ce chemin. Le bouton « Identifier avec mes infos » était touché de la même façon
- ✅ **La couleur du vin n'est plus transmise à l'IA par défaut** : le sélecteur valant « rouge » d'origine, l'envoyer systématiquement orientait la recherche vers un rouge alors que rien n'avait été choisi
